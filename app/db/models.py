...
class Doctor(Base):
    ...
    title = Column(String(20), nullable=False, default="Dr")
...
class LocumRequest(Base):
    ...
    approved_at = Column(DateTime)
    approval_comment = Column(Text)
    finance_approval_status = Column(String(30), default="NOT_REQUIRED")
    finance_approved_by = Column(String(100))
    finance_approved_at = Column(DateTime)
    finance_approval_comment = Column(Text)
